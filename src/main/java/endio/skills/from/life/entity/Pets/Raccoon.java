...
public class Raccoon extends TameableEntity implements IAnimatable {

    private AnimationFactory factory = new AnimationFactory(this);

    public Raccoon(EntityType<? extends TameableEntity> entityType, World world) {
    ...
    protected void initGoals() {
        ...
        this.goalSelector.add(2, new TemptGoal(this, 1.1, Ingredient.ofItems(new ItemConvertible[]{Items.GOLD_NUGGET}), false));
